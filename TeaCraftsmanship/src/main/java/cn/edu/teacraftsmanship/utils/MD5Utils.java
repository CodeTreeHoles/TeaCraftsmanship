package cn.edu.teacraftsmanship.utils;
...
public class MD5Utils {
    ...
    private static final String salt = "921083fsdia213jiowe";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(MD5Lower(plainText, salt));
        System.out.println(MD5Upper(plainText, salt));

        System.out.println("=====校验结果======");
        System.out.println(valid(plainText+salt,MD5Upper(plainText, salt)));
